"""Writer for SDMX-ML 3.0 reference metadata (GenericMetadata)."""
...
def write(
    ...
    """Writes reference metadata reports as SDMX-ML 3.0 GenericMetadata.
    ...
    outfile = write_metadata(
        reports, Format.REFMETA_SDMX_ML_3_0, prettyprint, header
    )
