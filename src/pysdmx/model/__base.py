...
class DataType(str, Enum):
    """The expected data type for a concept or representation."""
    ...
    EXC_VAL_RANGE = "ExclusiveValueRange"
    """Value facets provide the exclusive boundaries of a numeric range."""
    FLOAT = "Float"
    """A decimal number (4 bytes)."""
    GEO_INFO = "GeospatialInformation"
    """A string describing geographical features."""
    GREGORIAN_TIME_PERIOD = "GregorianTimePeriod"
    """This is the union of YEAR, YEAR_MONTH, and DATE."""
    INC_VAL_RANGE = "InclusiveValueRange"
    """Value facets provide the inclusive boundaries of a numeric range."""
    ...
    REP_TIME_PERIOD = "ReportingTimePeriod"
    ...
    """A time period defined by a distinct start and a duration."""
    URI = "URI"
...
class Facets(Struct, frozen=True, omit_defaults=True, repr_omit_defaults=True):
    """Additional information about the expected values.
