    ...
    def put_structures(
        ...
        Args:
            artefacts: The sequence of SDMX maintainable artefacts to upload.
                It has the same type as the ``structures`` attribute of a
                :class:`~pysdmx.model.message.StructureMessage`.
                Availability constraints are ignored.
        ...
        if len(structures) != len(artefacts):
            warnings.warn(
                "Availability constraints are generated by the FMR and cannot "
                "be uploaded: "
