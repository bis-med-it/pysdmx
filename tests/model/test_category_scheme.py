...
@pytest.fixture
def category_scheme(categories):
...
def test_categoryscheme_repr(category_scheme):
    r = repr(category_scheme)
    expected_repr = (
        ...
        "DataflowRef(agency='BIS', id='DF2')])], "
        "dataflows=[DataflowRef(agency='BIS', id='DF3')])])])"
    )
