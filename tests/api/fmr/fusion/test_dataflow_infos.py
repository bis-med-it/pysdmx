...
def no_hca_body_plus():
    with open("tests/api/fmr/samples/df/no_hca_plus.fusion.json", "rb") as f:
        return f.read()
...
def schema_body_plus():
    with open("tests/api/fmr/samples/df/schema_plus.fusion.json", "rb") as f:
        return f.read()


@pytest.fixture
def dataflow_body():
    with open("tests/api/fmr/samples/df/details.fusion.json", "rb") as f:
        return f.read()


@pytest.fixture
def dataflow_body_plus():
    with open("tests/api/fmr/samples/df/details_plus.fusion.json", "rb") as f:
        return f.read()


@pytest.fixture
def core_dataflow_body():
    with open("tests/api/fmr/samples/df/details_core.fusion.json", "rb") as f:
        return f.read()
